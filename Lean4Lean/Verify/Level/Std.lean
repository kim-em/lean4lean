...
theorem geqCore_eq_go : geqCore u v = go u v := by
  fun_induction go
  next u v ih₁ ih₂ =>
...
in [Lean 4.30's `Lean/Level.lean`](https://github.com/leanprover/lean4/blob/v4.30.0/src/Lean/Level.lean#L365-L390).

This is the sole additional trust assumption in this file and must be audited
when the pinned Lean toolchain changes. -/
@[simp] axiom eval_normalize : eval ρ μ l.normalize = eval ρ μ l
