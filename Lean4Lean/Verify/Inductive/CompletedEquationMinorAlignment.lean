import Lean4Lean.Verify.Inductive.CompletedEquationMinorContext
...
theorem
  ...
  have hshapeCanonical :
      H.origins.minorShapes O.owner O.owner_lt O.localIndex hshapeBound =
        H.origins.minorShapes owner P.owner_lt i P.local_lt :=
    H.origins.minorShapes_congr hposition.1 O.owner_lt P.owner_lt
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalSelectedMinorTargetAlignment
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalSelectedMinorIndexAlignment
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalSelectedMinorReplayedSource
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalSelectedMinorTransportedFieldContext
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalSelectedMinorSemanticFieldAlignmentFor
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalSelectedMinorSemanticFieldAlignment
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalSelectedMinorMaskAlignment
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
generated RHS spine. -/
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalSelectedMinorTranslatedArity
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalSelectedMinorTranslatedSplit
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalSelectedMinorNarrowFullContextAlignment
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalSelectedMinorIndependentInstalledContextAlignment
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalSelectedMinorIndependentInstalledFieldAlignment
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalSelectedMinorInstalledFieldAlignmentAtGeneratedPrefix
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalSelectedMinorInstalledFieldAlignmentInFullPrefix
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalSelectedMinorPositiveResidualTranslation
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalSelectedMinorFieldApplication
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalSelectedMinorFieldApplicationInIndependentContext
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalSelectedMinorFieldApplicationInIndependentContextFor
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalSelectedMinorInstalledFieldAlignmentInOuterScopeFor
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalSelectedMinorFieldApplicationInOuterScopeFor
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalOuterConstructorFieldRuntimeAlignmentFor
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalSelectedMinorRawHypothesisTypeAt
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalSelectedMinorPositionAlignment
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
