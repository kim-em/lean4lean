import Lean4Lean.Verify.Inductive.CompletedEquationRecursiveApplication
...
theorem CompletedRecursorPhasesResult.GeneratedRuleAlignment.iotaEquationTranslation
...
theorem CompletedRecursorPhasesResult.stagedIotaRuleTranslation
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
    ...
    Nonempty (A.rule.StagedIotaRuleTranslation H.outVEnv Us Delta
      R.context.venv decl (H.blockCertificate rules hrules).block
  ...
  have hrootVEnv : H.recursorWF.venv = R.context.venv :=
    H.recursorEnv
...
theorem CompletedRecursorPhasesResult.GeneratedIotaEquationTranslations.ruleLength
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
recursor phase. -/
theorem CompletedRecursorPhasesResult.GeneratedIotaEquationTranslations.build
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
    ...
    (hproj : ∀ {Delta : VLCtx} {s j e' e''}, TrProj Delta.toCtx s j e' e'' →
      ...
      e''.containsAnyConst
        ((H.blockCertificate allRules allRulesWF).block.recursors.map
          (·.name)) = false) :
    IotaBuildCertificate R.context.venv decl
...
theorem CompletedRecursorPhasesResult.GeneratedIotaEquationTranslations.completeLength
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem CompletedRecursorPhasesResult.ordinaryCompilationOfRuleTranslations
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
`VInductBlock.WF`. -/
structure CompletedRecursorPhasesResult.GeneratedEquationWitness
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
def CompletedRecursorPhasesResult.GeneratedRuleAlignment.abstractEquation
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
def CompletedRecursorPhasesResult.GeneratedRuleAlignment.equationWitnessOfBodies
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
