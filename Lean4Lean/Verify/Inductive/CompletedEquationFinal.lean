...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalCanonicalEquationBodies
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalCanonicalPositiveEquationWitness
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalCanonicalZeroEquationWitness
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalCanonicalEquationWitness
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
