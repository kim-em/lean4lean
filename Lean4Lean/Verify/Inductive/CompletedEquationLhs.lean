import Lean4Lean.Verify.Inductive.CompletedEquationRhs
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalCachedCanonicalLhsBody
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalCachedCanonicalLhsBodyFor
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
constructor fields. -/
theorem
    CompletedRecursorPhasesResult.GeneratedRuleAlignment.finalCachedCanonicalMinorFrame
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
def CompletedRecursorPhasesResult.GeneratedRuleAlignment.equationWitnessOfCanonicalBodies
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
...
def CompletedRecursorPhasesResult.GeneratedRuleAlignment.equationWitnessOfCachedBodies
    {c : AddInductive.Context} {stats : AddInductive.InductiveStats}
    {decl : VInductDecl} {nparams depth : Nat} {isUnsafe : Bool}
    {sourceEnv : VEnv} {indTypes : Array InductiveType}
    {ctorEnv outEnv : Environment}
