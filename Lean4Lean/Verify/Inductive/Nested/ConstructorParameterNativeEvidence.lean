...
theorem NestedExactFinalRunResult.nativeRestoredConstructorParameterDomains
  ...
  have hcanonicalTypesWF : E.assembly.canonical.venvTypes.WF :=
  ...
  have hvalidationValid : CheckingEnv.Valid
      (if isUnsafe then .unsafe else .safe) E.auxiliaryHeaderEnv
      E.assembly.canonical.venvTypes := by
    have HnativeTypesAdded := E.nativeSource.core.typesAdded
    rw [E.nativeSourceDecl_eq] at HnativeTypesAdded
    have hnativeTypes : E.nativeSource.envTypes =
        E.assembly.canonical.venvTypes :=
      Option.some.inj
        (HnativeTypesAdded.symm.trans E.assembly.typesAdded)
    rw [← hnativeTypes]
  ...
  have HfirstTranslation : TrExprS E.assembly.canonical.venvTypes lparams []
  ...
  have HconstructorTranslation : TrExprS
      E.assembly.canonical.venvTypes lparams []
  ...
  have hnativeScope : E.assembly.canonical.venvTypes.IsDefEqCtx
  ...
  have Hchecked' : CheckedConstructorParameterPrefix
    ...
    simpa only [Array.size_empty, Nat.zero_add, E.assembly.numParams] using
      Hchecked
  have HctorShapeTypes : decl.CtorParameterShape
      E.assembly.canonical.venvTypes nativeFamilyDomains
      decl.types[familyIdx].ctors[ctorIdx] := by
    apply Hchecked'.ctorParameterShape hcanonicalTypesWF hparameterWF.tr.wf
  ...
  have HctorShape : decl.CtorParameterShape
      ...
      decl.types[familyIdx].ctors[ctorIdx] :=
    HctorShapeTypes.mono
